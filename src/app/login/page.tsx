...
export default function LoginPage() {
  ...
  const fullText = "Your all-in-one tool to leverage trends: we generate hot content ideas and catchy captions for your products, then publish with one click to help you sell more."
  ...
  const handleOAuthLogin = async (provider: 'google' | 'apple' | 'facebook' | 'twitter') => {
    ...
    if (error) {
      ...
      if (errorMessage.includes('provider is not enabled') || errorMessage.includes('Unsupported provider')) {
        ...
        errorMessage = `${providerNames[provider]} login is not configured yet. Please use email login or contact support.`
      }
      setError(errorMessage)
      setLoading(false)
    }
    // OAuth 会自动重定向，所以不需要手动 router.push
  }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-white/20 backdrop-blur-sm border border-white/30">
        ...
        <div className="relative z-10 flex-1 flex items-center">
          <div className="max-w-xl">
            <h2 className="text-2xl lg:text-3xl font-medium text-white leading-relaxed mb-6">
              {displayedText}
        ...
        <div className="relative z-10">
          <div className="flex items-center space-x-8 text-white/80">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm">One-Click Publish</span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-8 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center space-x-3 mb-4">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-lg border border-gray-200 p-2">
              <img 
                src="/images/logo.png" 
                alt="HypeCat Logo" 
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-gradient-to-r from-orange-400 to-orange-500 shadow-sm">
          ...
          <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-xl">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600">Sign in to continue to HypeCat AI</p>
            </div>

            {error && (
              <div className="mb-3 p-3 bg-red-50 border-l-4 border-red-500 text-red-700 rounded">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">{" "}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-2.5 px-4 rounded-lg hover:from-orange-600 hover:to-orange-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0"
              >
                {loading ? (
            ...
            <div className="mt-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
                >
            ...
            <div className="mt-4">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-500">New to HypeCat AI?</span>
                </div>
              </div>
              ...
              <div className="mt-4 text-center">
                <Link 
                  href="/signup" 
                  className="inline-flex items-center justify-center w-full px-4 py-2.5 border-2 border-orange-500 text-orange-500 rounded-lg hover:bg-orange-50 transition-all font-semibold"
                >
                  Create an Account
